...
local listfastattack = {'Tấn công chậm','Tấn công bình thường','Tấn công nhanh','Tấn công siêu nhanh','Tấn công siêu siêu nhanh'}
	...
	if _G.FastAttackbaptuoihub_Mode == "Tấn công nhanh" then
		_G.Fast_Delay = 0.08
		
		elseif _G.FastAttackbaptuoihub_Mode == "Tấn công chậm" then
		_G.Fast_Delay = 0.15

	elseif _G.FastAttackbaptuoihub_Mode == "Tấn công bình thường" then
		_G.Fast_Delay = 0.6
		
		elseif _G.FastAttackbaptuoihub_Mode == "Tấn công siêu siêu nhanh" then
		_G.Fast_Delay = 0.01
		
	elseif _G.FastAttackbaptuoihub_Mode == "Tấn công siêu nhanh" then
		_G.Fast_Delay = 0.04
	end
end)
